(function ($) {
    new Vue({
        ...
        mounted(){
            var me = this;
            /*$(".bravo_flight_book").sticky({
                topSpacing:30,
                bottomSpacing:$(document).height() - $('.end_flight_sticky').offset().top + 40
            });*/
    ...
    $(".bravo_detail_flight .g-faq .item .header").click(function () {
        $(this).parent().toggleClass("active");
    });


    $(".bravo_detail_flight .g-itinerary").each(function () {
