...
class CreateFlightDatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('bravo_flights', function (Blueprint $table) {
            $table->tinyInteger('default_state')->default(1)->nullable();
        });
        Schema::create('bravo_flight_dates', function (Blueprint $table) {
