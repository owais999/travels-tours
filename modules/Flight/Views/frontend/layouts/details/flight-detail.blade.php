...
<div class="g-flight-feature">
    <div class="row">
        ...
        @endif
        @if(!empty($row->category_flight->name))
        @php $cat = $row->category_flight->translateOrOrigin(app()->getLocale()) @endphp
        <div class="col-xs-6 col-lg-3 col-md-6">
            <div class="item">
                <div class="icon">
                ...
                <div class="info">
                    <h4 class="name">{{__("Flight Type")}}</h4>
                    <p class="value">
                        {{$cat->name ?? ''}}
                    </p>
                </div>
...
@endif
@include('Flight::frontend.layouts.details.flight-include-exclude')
@include('Flight::frontend.layouts.details.flight-itinerary')
@include('Flight::frontend.layouts.details.flight-attributes')
@include('Flight::frontend.layouts.details.flight-faqs')
@if($row->map_lat && $row->map_lng)
<div class="g-location">
    <div class="location-title">
        <h3>{{__("Flight Location")}}</h3>
        @if($translation->address)
        <div class="address">
