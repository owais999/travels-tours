    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <div class="">
                ...
                @if($row->slug)
                <p class="item-url-demo">{{__("Permalink")}}: {{ url(config('flight.flight_route_prefix') ) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a>
                </p>
                @endif
            </div>
            <div class="">
                @if($row->slug)
                <a class="btn btn-primary btn-sm" href="{{$row->getDetailUrl(request()->query('lang'))}}" target="_blank">{{__("View Flight")}}</a>
                @endif
            </div>
        </div>
        ...
        <div class="lang-content-box">
            <div class="row">
                <div class="col-md-9">
                    ...
                    @include('Flight::admin/flight/flight-location')
                    @if(is_default_lang())
                ...
                <div class="col-md-3">
                    ...
                    @if(is_default_lang())
                    <div class="panel">
                        <div class="panel-title"><strong>{{__("Flight Featured")}}</strong></div>
                        <div class="panel-body">
                            <div class="form-group">
